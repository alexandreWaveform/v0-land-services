...
const ClientHomeScreen = () => {
  useEffect(() => {
    console.log("Client Home Screen mounted");
  }, []);
  ...
  return (
    <View style={appStyles.mainContainer}>
      ...
      <View style={appStyles.homeHeader}>
        <Text style={[appStyles.homeTitle, { color: colors.primary500 }]}>
          {i18n.t("landservices")}
        </Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 32 }} bounces={false}>
        <View style={appStyles.homeSection}>
          <Text
            style={[appStyles.homeSectionText, { color: colors.primary500 }]}
          >
            {i18n.t("next_service")}
          </Text>
          <Pressable onPress={() => router.push("/")}>
            <Text
              style={[appStyles.homeLabelText, { color: colors.primary500 }]}
            >
              {i18n.t("see_all")}
            </Text>
          </Pressable>
        ...
        <TouchableOpacity
          style={[
            ...
            appStyles.homeClientPrimaryBackground,
          ]}
          activeOpacity={0.8}
        ...
        >
          ...
          <View
            style={[appStyles.homeTopCardInnerContainer, { marginBottom: 8 }]}
          >
            <Image
        ...
        <View style={appStyles.homeCardRow}>
          {/* Pedidos Card */}
          <TouchableOpacity
            style={[appStyles.homeCard, appStyles.homeClientPrimaryBackground]}
            activeOpacity={0.8}
          ...
          <TouchableOpacity
            style={[appStyles.homeCard, appStyles.homeClientPrimaryBackground]}
            activeOpacity={0.8}
            onPress={() => router.push("/client/places")}
          >
            <View>
              <Image
